...
inline bool operator==(const AlignmentPath & lhs, const AlignmentPath & rhs) { 
...
inline ostream & operator<<(ostream & os, const AlignmentPath & align_path) {
...
inline ostream & operator<<(ostream & os, const vector<AlignmentPath> & align_paths) {
