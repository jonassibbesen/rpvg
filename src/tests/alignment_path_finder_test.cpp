...
TEST_CASE("Alignment path(s) can be found from a single-end alignment") {
    ...
    SECTION("Single-end read alignment finds alignment path(s)") {    
        ...
        REQUIRE(paths_index.locatePathIds(alignment_paths.back().search_state) == vector<gbwt::size_type>({0}));
    }
...
TEST_CASE("Alignment path(s) can be found from a paired-end alignment") {
    ...
    SECTION("Paired-end read alignment finds alignment path(s)") {
        ...
        REQUIRE(alignment_paths.back().frag_length == 19);
    ...
    SECTION("Extended paired-end read alignment finds alignment path(s)") {
        ...
        REQUIRE(alignment_paths_ext.front() == alignment_paths.back());
    ...
    SECTION("Partial overlapping paired-end read alignment finds alignment path(s)") {
        ...
        REQUIRE(alignment_paths_ov.front() == alignment_paths.front());
        REQUIRE(alignment_paths_ov.back() == alignment_paths.at(1));
    ...
    SECTION("Perfect overlapping paired-end read alignment finds alignment path(s)") {
        ...
        REQUIRE(paths_index.locatePathIds(alignment_paths_ov_1.back().search_state) == vector<gbwt::size_type>({0, 2}));
        ...
        REQUIRE(paths_index.locatePathIds(alignment_paths_ov_2.front().search_state) == vector<gbwt::size_type>({0, 2, 3}));
    ...
    SECTION("Paired-end read alignment finds forward alignment path(s) in bidirectional index") {
        ...
        REQUIRE(alignment_paths_bd.front() == alignment_paths.at(1));
        REQUIRE(alignment_paths_bd.at(1) == alignment_paths.back());     
    }
}
...
TEST_CASE("Alignment path(s) can be found from a single-end multipath alignment") {
    ...
    SECTION("Single-end multipath read alignment finds alignment path(s)") {
        ...
        REQUIRE(alignment_paths.front().frag_length == 8);
        REQUIRE(alignment_paths.front().min_mapq == 10);
        REQUIRE(alignment_paths.front().score_sum == 6);
        REQUIRE(paths_index.locatePathIds(alignment_paths.front().search_state) == vector<gbwt::size_type>({1}));                
  
        REQUIRE(alignment_paths.back().frag_length == alignment_paths.front().frag_length);
        REQUIRE(alignment_paths.back().min_mapq == alignment_paths.front().min_mapq);
        REQUIRE(alignment_paths.back().score_sum == 8);
        REQUIRE(paths_index.locatePathIds(alignment_paths.back().search_state) == vector<gbwt::size_type>({0}));                
    }
    ...
    SECTION("Single-end multipath read alignment finds forward alignment path(s) in bidirectional index") {
        ...
        REQUIRE(alignment_paths_bd.front().min_mapq == alignment_paths.front().min_mapq);
        REQUIRE(alignment_paths_bd.front().score_sum == alignment_paths.front().score_sum);
        REQUIRE(paths_index_bd.locatePathIds(alignment_paths_bd.front().search_state) == vector<gbwt::size_type>({1}));
...
TEST_CASE("Alignment path(s) can be found from a paired-end multipath alignment") {
    ...
    SECTION("Paired-end multipath read alignment finds alignment path(s)") {
        ...
        REQUIRE(alignment_paths.at(1).frag_length == 13);
        REQUIRE(alignment_paths.at(1).min_mapq == alignment_paths.front().min_mapq);
        REQUIRE(alignment_paths.at(1).score_sum == 5);
        REQUIRE(paths_index.locatePathIds(alignment_paths.at(1).search_state) == vector<gbwt::size_type>({2})); 
    ...
    SECTION("Partial overlapping paired-end read alignment finds alignment path(s)") {
        ...
        REQUIRE(alignment_paths_ov.front().frag_length == 9);
        REQUIRE(alignment_paths_ov.front().min_mapq == alignment_paths.front().min_mapq);
        REQUIRE(alignment_paths_ov.front().score_sum == alignment_paths.front().score_sum);
    ...
    SECTION("Perfect overlapping paired-end multipath read alignment finds alignment path(s)") {
        ...
        REQUIRE(alignment_paths_ov_1.front().frag_length == 3);
        REQUIRE(alignment_paths_ov_1.front().min_mapq == 10);
        REQUIRE(alignment_paths_ov_1.front().score_sum == 4);
        REQUIRE(paths_index.locatePathIds(alignment_paths_ov_1.front().search_state) == vector<gbwt::size_type>({2}));                
        ...
        REQUIRE(alignment_paths_ov_1.back().frag_length == 6);
        REQUIRE(alignment_paths_ov_1.back().min_mapq == alignment_paths_ov_1.at(1).min_mapq);
        REQUIRE(alignment_paths_ov_1.back().score_sum == 6);
        REQUIRE(paths_index.locatePathIds(alignment_paths_ov_1.back().search_state) == vector<gbwt::size_type>({0}));                
        ...
        REQUIRE(alignment_paths_ov_2.front().min_mapq == 20);
        REQUIRE(alignment_paths_ov_2.front().score_sum == 2);
        REQUIRE(paths_index.locatePathIds(alignment_paths_ov_2.front().search_state) == vector<gbwt::size_type>({0}));                
        ...
        REQUIRE(alignment_paths_ov_2.at(1).score_sum == 6);
        REQUIRE(paths_index.locatePathIds(alignment_paths_ov_2.at(1).search_state) == vector<gbwt::size_type>({2}));                
        ...
        REQUIRE(alignment_paths_ov_2.back().score_sum == alignment_paths_ov_2.at(1).score_sum);
        REQUIRE(paths_index.locatePathIds(alignment_paths_ov_2.back().search_state) == vector<gbwt::size_type>({1}));                
    }
    ...
    SECTION("Strand-specific paired-end multipath read alignment finds unidirectional alignment path(s)") {
        ...
        REQUIRE(alignment_paths_rf.front() == alignment_paths.at(1));
    }

    SECTION("Alignment pairs from a paired-end multipath alignment are filtered based on length") {

        AlignmentPathFinder<vg::MultipathAlignment> alignment_path_finder_len13(paths_index, "unstranded", 13, 0, 0, 0, 1);

        auto alignment_paths_len13 = alignment_path_finder_len13.findPairedAlignmentPaths(alignment_1, alignment_2);        
        REQUIRE(alignment_paths_len13.size() == 3);
        
        REQUIRE(alignment_paths_len13 == alignment_paths);

        AlignmentPathFinder<vg::MultipathAlignment> alignment_path_finder_len10(paths_index, "unstranded", 10, 0, 0, 0, 1);
        ...
        REQUIRE(alignment_paths_len10.front() == alignment_paths.front());
        
        AlignmentPathFinder<vg::MultipathAlignment> alignment_path_finder_len9(paths_index, "unstranded", 9, 0, 0, 0, 1);
